...
const bob = '0xF693807ac9B654C8FbC59587Fa4de2d908EDDa17'
const bob  = '0x2Dc028fa731Ade3B0C190c45Ccb504e16924c2D4'
const dev = '0x41FB38d8A49ef53836016455A1Dff8bCBb884fb4'
const minter = '0xFDC1dB43Fdf1c3a33254BBb7A8F644503734F449'
...
//	this.chef = await MasterChef.new(this.mvs.address, dev, '100', '0', '1000', '2000', { from: alice });
    ...
    xit('should allow dev and only dev to update dev', async () => {
        this.chef = await MasterChef.new(this.mvs.address, dev, '100', '0', '1000', '2000', { from: alice });
    ...
    context('With ERC/LP token added to the field', () => {
        ...
        xit('should not allow emergency withdraw before global lock and should allow after global lock', async () => {
        ...
        xit('should give out MVSs only after farming time', async () => {
            // 100 per block farming rate starting at block 100 with bonus until block 1000
        ...
        xit('should not distribute MVSs if no one deposit', async () => {
        ...
        xit('should distribute MVSs properly for each staker', async () => {
        ...
        xit('should give proper MVSs allocation to each pool', async () => {
        ...
        xit('should stop giving bonus MVSs after the bonus period ends', async () => {
        ...
        xit('should stop reward after rewardEndBlock of pool', async () => {
            // 100 per block farming rate starting at block 500 with bonus until block 600
        ...
        xit('should not allow withdraw lp before lock and allow after lock', async () => {
            // 100 per block farming rate starting at block 500 with bonus until block 600
            this.chef = await MasterChef.new(this.mvs.address, dev, '100', '1000', '2000', '3000', { from: alice });
            await this.mvs.transferOwnership(this.chef.address, { from: alice });
            await this.lp.approve(this.chef.address, '1000', { from: alice });
        ...
        xit('should not allow withdraw lp more than deposit', async () => {
            // 100 per block farming rate starting at block 500 with bonus until block 600
            this.chef = await MasterChef.new(this.mvs.address, dev, '100', '1000', '2000', '3000', { from: alice });
            await this.mvs.transferOwnership(this.chef.address, { from: alice });
            await this.lp.approve(this.chef.address, '1000', { from: alice });
